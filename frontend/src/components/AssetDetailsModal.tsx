        ...
        <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 3 }}>
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
            ...
            <Box>
              ...
              <Typography variant="body1">{asset.asset_type_name}</Typography>
            </Box>
            ...
            <Box>
              ...
              <Typography variant="body1">
                {getAllocationLabel(asset.allocation)}
              </Typography>
            </Box>
            ...
            {asset.stock_symbol && (
              <Box>
                ...
                <Typography variant="body1">{asset.stock_symbol}</Typography>
              </Box>
            )}
            ...
            {asset.shares && (
              <Box>
                ...
                <Typography variant="body1">{asset.shares}</Typography>
              </Box>
            )}
          </Box>
          ...
          <Box sx={{ mt: 3, p: 2, bgcolor: "grey.50", borderRadius: 1 }}>
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              <Chip
                icon={<LinkIcon />}
                label={`Linked to ${
                  asset.link_data.plugin_object?.name || "YNAB Account"
                }`}
                color="primary"
                size="small"
              />
