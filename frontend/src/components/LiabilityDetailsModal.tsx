...
interface LiabilityDetailsModalProps {
  open: boolean;
  onClose: () => void;
  liability: any;
  onEdit: () => void;
...
export default function LiabilityDetailsModal({
  open,
  onClose,
  liability,
  onEdit,
  onDelete,
}: LiabilityDetailsModalProps) {
  if (!liability) {
    return null;
  }
    ...
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      <DialogTitle>
        <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
          <Typography variant="h6">Liability Details</Typography>
          {liability.link_data && (
        ...
        <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 3 }}>
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
            ...
            <Box>
              ...
              <Typography variant="body1">
                {liability.bank_name || "Not specified"}
              </Typography>
            </Box>
            ...
            <Box>
              ...
              <Typography variant="body1">
                {getAllocationLabel(liability.allocation)}
              </Typography>
            </Box>
          </Box>
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
            ...
            <Box>
              ...
              <Typography variant="body1">
                {formatCurrency(liability.cleared_balance)}
              </Typography>
            </Box>
          ...
          <Box sx={{ mt: 3, p: 2, bgcolor: "grey.50", borderRadius: 1 }}>
            ...
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              <Chip
                icon={<LinkIcon />}
                label={`Linked to ${
                  liability.link_data.plugin_object?.name || "YNAB Account"
                }`}
                color="primary"
                size="small"
              />
