...
# Override the build_container function to use our installation script
...
EOF
  ...
  # Install Finance Assistant using our installation script from our repository
  msg_info "Installing Finance Assistant inside container $CTID..."
  lxc-attach -n "$CTID" -- bash -c "$(curl -fsSL https://raw.githubusercontent.com/chbarnhouse/finance-assistant/main/install/financeassistant.sh)" $?
}
